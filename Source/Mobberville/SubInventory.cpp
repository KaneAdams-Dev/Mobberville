...
USubInventory::USubInventory()
{
}

int32 USubInventory::MaxSize()
{
	return size;
}

void USubInventory::SetMaxSize(int32 newSize)
{
	if (newSize < size)
	{
...
const TArray<FInventoryStack>& USubInventory::GetItems()
{
	return items;
}

int64 USubInventory::AddItem(AItem* item, int64 count)
{
	if (count == 0)
	{
